...
const char *outputDescription[NO_OF_TYPES] =
{
	"Unused", 
	"Bottom Element", 
	"Top Element", 
...
void initOutputs()
{
	...
	portAOut	 = portOutputRegister(digitalPinToPort(PORT_A_OUTPUT));
	portAMode	= portModeRegister(digitalPinToPort(PORT_A_OUTPUT));
	portBOut	 = portOutputRegister(digitalPinToPort(PORT_B_OUTPUT));
	portBMode	= portModeRegister(digitalPinToPort(PORT_B_OUTPUT)); 
