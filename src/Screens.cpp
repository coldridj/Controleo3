...
const char* inertiaDescription[] = {
	...
	"30~C rise in 60 sec",
	"30~C rise in 80 sec", 
	"30~C rise in 2 minutes", 
	"30~C rise in 3 minutes"
};

const char* insulationDescription[] = {
	"Insulation is poor", 
	"Insulation is pretty good", 
	"Insulation is excellent", 
	"Like me, it is amazing!"
};
...
{ 
	...
	while (1) {
		...
		Serial.print("fillScreen in "); Serial.println(micros() - start);
...
redraw:
		...
		Serial.print("showScreen in "); Serial.println(micros() - start);
		delay(1000);
	} // end of while (1)
}
